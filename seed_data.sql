...
CREATE TABLE `arms` (
  ...
  CONSTRAINT `armRace` FOREIGN KEY (`race`) REFERENCES `races` (`race`)
...
CREATE TABLE `lords` (
  ...
  CONSTRAINT `lordRace` FOREIGN KEY (`race`) REFERENCES `races` (`race`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `races` VALUES ('Darkelves','Naggaroth','The Dark Elves are a sadistic, cruel race who dwell in the cold, bleak land of Naggaroth after long ago being exiled from Ulthuan.'),('Highelves','Ulthuan','The High Elves are an ancient, proud race who dwell on the island-continent of Ulthuan, once home to all Elves.'),('Lizardmen','Lustria','Lizardmen are not a single race but a society of different cold-blooded creatures who dwell in temple-cities in southern jungles. '),('Skaven','Underground','The Skaven are a race of vicious mutant rat-men who lurk in a vast Under-Empire below the world. ');
...
INSERT INTO `users` VALUES (1,'harry@gmail.com','123456'),(2,'ronald@gmail.com','654321');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wartests`
--

DROP TABLE IF EXISTS `wartests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wartests` (
  `warID` int NOT NULL,
  ...
  CONSTRAINT `troop1` FOREIGN KEY (`troopID1`) REFERENCES `troops` (`troopID`),
  CONSTRAINT `troop2` FOREIGN KEY (`troopID2`) REFERENCES `troops` (`troopID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wartests`
--

LOCK TABLES `wartests` WRITE;
/*!40000 ALTER TABLE `wartests` DISABLE KEYS */;
/*!40000 ALTER TABLE `wartests` ENABLE KEYS */;
UNLOCK TABLES;
